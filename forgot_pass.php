<?php 
    session_start(); 
    if ((isset($_SESSION['mail_null'])) && ($_SESSION['mail_null']==true)) {
        $_SESSION['null_info'] = '<p class ="error"> Nie znaleziono konta z podanym adresem e-mail </p>';
    }
?>
<!DOCTYPE html>
<html lang="pl">
...
<body>
<form action="send_pass.php" method="post" class="main">
    <p id="heading">Resetowanie hasła</p>
    <div class="field">
    ...
    <?php 
    if(isset($_SESSION['null_info'])) {
        echo $_SESSION['null_info'];
        unset ($_SESSION['null_info']); }
    ?><br/>
